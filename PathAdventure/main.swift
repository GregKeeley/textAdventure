...
if snoozePress == ("yes") {
    ...
    print("Great job \(String(describing: userInfo.name))! you didn't hit the snooze button! But you had a 3 course including \(String( describing: userInfo.breakfast)) breakfast that took way too long to make.")
}
...
if subwayPath1 == 1 {
    print("""
        ...
        You get on the local train, and start listening to \(String(describing: userInfo.music)) and cross your fingers the train will arrive on time.
